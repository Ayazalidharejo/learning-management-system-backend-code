...
exports.forgotPassword = async (req, res) => {
  ...
  try {
    ...
    console.log(`Reset token generated for ${user.email}: ${token}`);
    ...
    // Make sure the frontend URL matches exactly where your React app is hosted
    const frontendURL = 'https://learning-management-system-frontend.vercel.app'; // Update this to your actual frontend URL
